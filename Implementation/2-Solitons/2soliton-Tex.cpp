...
const double dx = 0.4;
const double dt = 0.1;
const double Tmax = 4080.*dt; //Time steps
...
void init_gnuplot_contour(void)
{
  ...
  std::cout << "set output 'SolitonP2_Contour.tex'" << std::endl;
  std::cout << "unset surface" << std::endl;
  std::cout << "set xlabel \" $x$ \" " << std::endl;
  std::cout << "set ylabel \" $t$ \" " << std::endl;
  std::cout << "set ytics (0,80,160,240,320,400)"  << std::endl;//<<0 <<", "<< LX <<","<< NT/80 << std::endl;  
  ...
  std::cout << "set cbrange [-0.1:0.9]" << std::endl;
...
void init_gnuplot_3D(void)
{
  ...
  std::cout << "set output 'SolitonP2_3D.tex'" << std::endl;
  //std::cout << "set title \" Soliton \" " << std::endl;
  std::cout << "unset key" << std::endl;
  std::cout << "set xlabel \" $x$ \" " << std::endl;
